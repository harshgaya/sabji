...
class ColorsConsts {
  ...
  static Color gradiendFStart =const Color(0xFF6B52A7); //purpleaccent 100
  ...
  static Color blue =const Color(0xFF6f35a4);
  static Color green =const Color(0xff26A541);
  static Color AppMainColor = const Color(0xFF0AA034);
  static Color AppSecColor = const Color(0xFF0FC642);
